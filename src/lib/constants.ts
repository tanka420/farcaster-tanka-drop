 ...
 */
export const APP_NAME: string = 'NFT Farcaster';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'NFT Farcaster by TANKA';
 ...
 */
export const APP_TAGS: string[] = ['nft', 'mint', 'base', 'farcaster', 'zora'];
